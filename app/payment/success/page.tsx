...
export default function PaymentSuccessPage() {
    ...
    useEffect(() => {
        ...
        // Short delay to allow webhook to fire, then navigate to tracking
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center gap-6 p-6">
            ...
            <div className="text-center">
                <h1 className="text-white font-black text-xl uppercase tracking-widest">Payment Received!</h1>
                <p className="text-white/50 text-sm mt-2">Taking you to your order tracker…</p>
            </div>
